<%@ Page Title="CUSTOMER DETAILS" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CustomerLoanDetails.aspx.cs" Inherits="LoanAppSystem.ClientAccount.CustomerDetails1" %>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a class="menu-top-active" href="CustomerLoanDetails.aspx">CUSTOMER DETAILS</a></li>
